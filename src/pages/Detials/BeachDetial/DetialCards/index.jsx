  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <Box sx={{ display: "flex" }}>
            ...
            <Rating value={Finddata.rating} readOnly />
        ...
        <Box sx={{ display: "flex", gap: "20px", alignItems: "center" }}>
          <Box>
            <Typography variant="h5">{Finddata.price}</Typography>
      ...
      <Box sx={{ display: "flex", borderRadius: "20px", gap: "20px" }}>
        <Box sx={{ width: "70%" }}>
          <img src={Finddata.imgUTL} alt="" width={710} height={400} />
        </Box>
        <Box
          sx={{
            display: "flex",
        ...
        >
          ...
          >
            ...
            <Box>
              <Box>
                <img src={Finddata.imgUTL} alt="" width={300} />
              </Box>
            </Box>
          </Box>
        </Box>
